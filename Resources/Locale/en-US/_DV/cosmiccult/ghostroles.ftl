...
ghost-role-information-malign-critter-name = Malign Critter
ghost-role-information-malign-critter-description = Wreak havoc. Usher in the end of all things.
ghost-role-information-malign-critter-rules = You are a [color={role-type-team-antagonist-color}][bold]{role-type-team-antagonist-name}[/bold][/color] with any entropic colossi or cosmic cultists that may be present.
